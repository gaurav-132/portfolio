    ...
    return (
      <div>
        <div className={`w-full  bg-cover bg-no-repeat bg-[url('https://ez-snippet.vercel.app/images/cover.jpeg')]`}>
            <div className='flex resp-main justify-center gap-2 md:gap-10 md:px-10 py-5 bg-blur backdrop-filter backdrop-blur-md'>
                <div className=''>
                    <img className='rounded-full border-4 object-cover img-resp' width={120} src='https://avatars.githubusercontent.com/u/109432749?v=4'/>
                </div>
                <div className='flex md:flex-1 justify-between items-center gap-4'>
                    <div className='text-3xl text-white title-resp'>
                        Programming Hub
                    </div>
